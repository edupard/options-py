...
def algo_basic_fix_19_00():
    ...
    for fut_code in fut_codes:
        ...
        BAR_4H_S_H, BAR_4H_S_M = config.get_config().ALGO_BASIC_FIX_19_00_4H_BAR
        ...
        if strikes.shape[0] == 0:
            ...
            px_grid = np.zeros((1))
            px_grid[0] = under_px
            delta_grid = utils.get_portfolio_delta_on_grid(fut_code, px_grid, utils.default_time_shift_strategy,
                                                           DELTA_TIME)
        ...
        delta_grid = utils.get_portfolio_delta_on_grid(fut_code, px_grid, utils.default_time_shift_strategy, DELTA_TIME)
        ...
        if change_px.shape[0] == 0:
            ...
            if round(delta_grid[0]) == 0:
                if under_px < min_strike:
                    ...
                    delta_grid = utils.get_portfolio_delta_on_grid(fut_code, buy_px_grid,
                    ...
                    delta_grid = utils.get_portfolio_delta_on_grid(fut_code, sell_px_grid,
                                                                   utils.default_time_shift_strategy, DELTA_TIME)
        ...
        # delta changes sign
            ...
            delta_grid = utils.get_portfolio_delta_on_grid(fut_code, buy_px_grid, utils.default_time_shift_strategy,
                                                           DELTA_TIME)
            ...
            delta_grid = utils.get_portfolio_delta_on_grid(fut_code, sell_px_grid, utils.default_time_shift_strategy,
                                                           DELTA_TIME)
            rounded_delta_grid = np.round(delta_grid)
            mask = rounded_delta_grid == 0
